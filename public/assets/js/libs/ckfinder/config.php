...
*/
$config['Thumbnails'] = config('candy.core.ckfinder.thumbnails');
/*
Set the maximum size of uploaded images. If an uploaded image is larger, it
gets scaled down proportionally. Set to 0 to disable this feature.
*/
$config['Images'] = config('candy.core.ckfinder.images');
/*
...
*/
$config['AccessControl'][] = config('candy.core.ckfinder.access_control');
/*
...
$config['ResourceType'] = config('candy.core.ckfinder.resource_type');
/*
