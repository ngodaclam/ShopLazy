<div class="topbar">
    ...
    <div class="header-right">
        <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="user-header">
                ...
                <ul class="dropdown-menu">
                    @foreach($locales as $locale)
                        <li>
                            <a href="{{ route('locale', ['code' => $locale->code]) }}">
                                @if ($locale->image)
                                    <img src="{{ Theme::asset()->url("img/flags/$locale->image") }}" alt="flag-english">
                                @endif
                                <span> {{ $locale->name }}</span></a>
                        </li>
                    @endforeach
                </ul>
            </li>
            ...
            {{--<li class="dropdown" id="messages-header">--}}
                ...
                {{--<ul class="dropdown-menu">--}}
                    ...
                    {{--<li class="dropdown-body">--}}
                        ...
                        {{--<img src="{{ url('themes/default/assets/img/avatars/avatar3.png') }}" alt="avatar 3">--}}
                        {{--</span>--}}
                                {{--<div class="clearfix">--}}
                                    {{--<div>--}}
                            ...
                            {{--<li class="clearfix">--}}
                        {{--<span class="pull-left p-r-5">--}}
                        {{--<img src="{{ url('themes/default/assets/img/avatars/avatar4.png') }}" alt="avatar 4">--}}
                        {{--</span>--}}
                                {{--<div class="clearfix">--}}
                                    {{--<div>--}}
                            ...
                            {{--<li class="clearfix">--}}
                        {{--<span class="pull-left p-r-5">--}}
                        {{--<img src="{{ url('themes/default/assets/img/avatars/avatar5.png') }}" alt="avatar 5">--}}
                        {{--</span>--}}
                                {{--<div class="clearfix">--}}
                                    {{--<div>--}}
                            ...
                            {{--<li class="clearfix">--}}
                        {{--<span class="pull-left p-r-5">--}}
                        {{--<img src="{{ url('themes/default/assets/img/avatars/avatar6.png') }}" alt="avatar 6">--}}
                        {{--</span>--}}
                                {{--<div class="clearfix">--}}
                                    {{--<div>--}}
            ...
            <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img src="{{ session('user.avatar') ?: url('themes/default/assets/img/avatars/avatar1_big@2x.png') }}" alt="user image">
                    <span class="username">{!! trans('core::user.welcome', ['name' => session('user.name')]) !!}</span>
                </a>
                <ul class="dropdown-menu">
                    <li>
                        <a href="{!! route('user.profile') !!}">
                            <i class="icon-settings"></i><span>{!! trans('core::user.account_settings') !!}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('logout') }}">
                            <i class="icon-logout"></i><span>{!! trans('core::user.logout') !!}</span>
                        </a>
                    </li>
                </ul>
            </li>
