$(function() {
    ...
    if($('body').data('page') == 'login'){
        ...
        //    l.start();
        //    setTimeout(function() {
        //        window.location.href = $('form[id=form-signin]').attr('action');
        //    }, 2000);
        //});
        $.backstretch(["/themes/default/assets/img/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["themes/default/assets/img/gallery/login4.jpg", "themes/default/assets/img/gallery/login3.jpg", "themes/default/assets/img/gallery/login2.jpg", "themes/default/assets/img/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
