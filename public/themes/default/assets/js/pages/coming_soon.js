...
$(document).ready(function() {
    if ($('#map').length) {
        ...
        /* Background Slide */
        $.backstretch([ "themes/dark_candy/assets/img/gallery/login4.jpg", "themes/dark_candy/assets/img/gallery/login3.jpg", "themes/dark_candy/assets/img/gallery/login2.jpg", "themes/dark_candy/assets/img/gallery/login.jpg"],{fade: 600, duration: 4000
        });
    }
    map_height();
