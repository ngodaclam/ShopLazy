$(function(){
    ...
    (function() {
        ...
        $("#set-img-1").click(function() {
            ...
            $image.cropper("setImgSrc", "themes/dark_candy/assets/img/gallery/picture-1.jpg");
        });
        ...
        $("#set-img-2").click(function() {
            ...
            $image.cropper("setImgSrc", "themes/dark_candy/assets/img/gallery/picture-2.jpg");
        });
        ...
        $("#set-img-3").click(function() {
            ...
            $image.cropper("setImgSrc", "themes/dark_candy/assets/img/gallery/picture-3.jpg");
        });
