$(function() {
    $.backstretch(["themes/dark_candy/assets/img/gallery/login4.jpg", "themes/dark_candy/assets/img/gallery/login3.jpg", "themes/dark_candy/assets/img/gallery/login2.jpg", "themes/dark_candy/assets/img/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    /* Background Slide */
    $('.bg-slider').backstretch(["themes/dark_candy/assets/img/gallery/login4.jpg", "themes/dark_candy/assets/img/gallery/login3.jpg", "themes/dark_candy/assets/img/gallery/login2.jpg", "themes/dark_candy/assets/img/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    $('#image-cb').change(function() {
        if ($(this).is(":checked")) {
            $.backstretch(["themes/dark_candy/assets/img/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
            });
