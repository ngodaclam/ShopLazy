<div class="row">
    @if (isset($widgets['dashboard']))
        @foreach($widgets['dashboard'] as $widget)
            @if (isset($widget['panel']))
                <div class="panel">
                    <div class="panel-header">
                        <h3>
                            @if (isset($widget['panel']['icon']))
                                <i class="{!! $widget['panel']['icon'] !!}"></i>
                            @endif
                            {!! $widget['panel']['title'] !!}
                        </h3>
                    </div>
                    @if (isset($widget['panel']['content']) && $widget['panel']['content'])
                        <div class="panel-content widget-{!! isset($widget['panel']['size']) ? $widget['panel']['size'] : 'full' !!} {!! isset($widget['panel']['class']) ?$widget['panel']['class'] : '' !!}">
                    @endif
            @endif
            {!! Widget::call($widget['tag'], $widget['params']) !!}
            @if (isset($widget['panel']))
                @if (isset($widget['panel']['content']) && $widget['panel']['content'])
                    </div>
                @endif
                ...
                <div class="panel no-bd bd-3 panel-stat">
                    ...
                    <div class="panel-body p-15 p-b-0">
                        <div class="row m-b-10">
                            ...
                            <div class="col-xs-9">
                                <div class="live-tile" data-mode="carousel" data-direction="vertical" data-delay="3500"
                                     data-height="60">
                                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="live-tile f-right" data-mode="carousel" data-direction="vertical"
                                     data-delay="3500" data-height="23">
                                    <div>
                ...
                <div class="tab_right">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="yahoo-tab" style="display:none">
                            ...
                            <div class="company-info">Yahoo! Inc. is an American multinational Internet corporation
                                headquartered in Sunnyvale, California. It is globally known for its Web portal, search
                                engine Yahoo Search, and related services.
                            </div>
                        </div>
                        <div class="tab-pane active" id="google-tab">
                            <div id="stock-google"></div>
                            <div class="company-info">Google is a United States-headquartered, multinational corporation
                                specializing in Internet-related services and products. These include online advertising
                                technologies, search, cloud computing, and software.
                            </div>
                        </div>
                        <div class="tab-pane" id="nokia-tab" style="display:none">
                            <div id="stock-nokia"></div>
                            <div class="company-info">Nokia is a Finnish multinational communications and information
                                technology company. Nokia employed 90,000 people across 120 countries, conducts sales in
                                more than 150 countries and reported annual revenues of around €12.7 billion.
                            </div>
                        </div>
                        <div class="tab-pane" id="htc-tab" style="display:none">
                            <div id="stock-htc"></div>
                            <div class="company-info">HTC Corporation is a Taiwanese manufacturer of smartphones and
                                tablets. Founded in 1997, HTC began designing and manufacturing devices such as mobile
                                phones, touchscreen phones, and PDAs based on Windows Mobile OS.
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-md-4 col-sm-6 portlets">
        ...
        <div class="panel widget-member clearfix">
            <div class="col-xs-3">
                <img src="{{ url('themes/default/assets/img/avatars/ngocnh.jpeg') }}" alt="avatar 12"
                     class="pull-left img-responsive">
            </div>
            <div class="col-xs-9">
                <h3 class="m-t-0 member-name"><strong>Ngọc Nguyễn</strong></h3>
                <p class="member-job">Software Engineer</p>
                <div class="row">
                    <div class="col-xlg-6">
                        <p><i class="icon-envelope c-gray-light p-r-10"></i> me@ngocnh.info</p>
                        <p><i class="fa fa-facebook c-gray-light p-r-10"></i> fb.com/ngocnh210</p>
                    </div>
                    <div class="col-xlg-6 align-right">
                        <p><i class="icon-calendar c-gray-light p-r-10"></i> 14 July 1989</p>
                        <p><i class="icon-target c-gray-light p-r-10"></i> Ha Noi</p>
                    </div>
                </div>
            </div>
        </div>
